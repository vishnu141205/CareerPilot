...
const Drawer = ({ isOpen, onClose, title, children }) => { // <-- Added 'children' here
  return ( // <-- Added opening parenthesis here!
    <div 
      className={`fixed top-[64px] right-0 z-40 h-[calc(100dvh-64px)] p-4 overflow-y-auto transition-transform bg-white w-full md:w-[40vw] shadow-2xl shadow-gray-500/50 border-r border-l-gray-200
